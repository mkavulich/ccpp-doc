...
.. table:: *Suites supported in the CCPP v7.0 release*
   ...
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Physics Suite       | GFS_v16          | `GFS_v17_p8`  | `RAP`       |`RRFS_v1beta`| `WoFS`      | `HRRR`      |
   +=====================+==================+===============+=============+=============+=============+=============+
   | **Supported hosts** | **SCM/SRW**      | **`SCM`**     | **`SCM`**   |**`SCM/SRW`**|**`SCM/SRW`**|**`SCM/SRW`**|
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Microphysics        | GFDL             | `Thompson`    | `Thompson`  | `Thompson`  | `NSSL`      | `Thompson`  |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | PBL                 | TKE EDMF         | `TKE EDMF`    | `MYNN-EDMF` | `MYNN-EDMF` | `MYNN-EDMF` | `MYNN-EDMF` |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Deep convection     | saSAS            | `saSAS + CA`  | `GF`        | :gi:`N/A`   | :gi:`N/A`   | :gi:`N/A`   |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Shallow convection  | saMF             | `saMF`        | `GF`        | :gi:`N/A`   | :gi:`N/A`   | :gi:`N/A`   |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Radiation           | RRTMG            | `RRTMG`       | `RRTMG`     | `RRTMG`     | `RRTMG`     | `RRTMG`     |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Surface layer       | GFS              | `GFS`         | `MYNN-SFL`  | `MYNN-SFL`  | `MYNN-SFL`  | `MYNN-SFL`  |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Gravity Wave Drag   | CIRES-uGWP       | `Unified-uGWP`| `GSL drag`  | `CIRES-uGWP`| `CIRES-uGWP`| `GSL drag`  |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Land surface        | Noah             | `Noah-MP`     | `RUC`       | `Noah-MP`   | `Noah-MP`   | `RUC`       |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Ozone               | NRL 2015         | `NRL 2015`    | `NRL 2015`  | `NRL 2015`  | `NRL 2015`  | `NRL 2015`  |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
   | Strat H\ :sub:`2`\ O| NRL 2015         | `NRL 2015`    | `NRL 2015`  | `NRL 2015`  | `NRL 2015`  | `NRL 2015`  |
   +---------------------+------------------+---------------+-------------+-------------+-------------+-------------+
...
The operational GFS_v16 suite includes `GFDL microphysics <https://dtcenter.ucar.edu/GMTB/v7.0.0/sci_doc/_g_f_d_l_cloud.html>`_, 
